...
% ---------------------------------------------------------------------------
\chapter{Experiment 14: Recurrent Neural Network (RNN)}\label{exp:14}
...
\begin{lstlisting}[style=mlcode,caption={Recurrent model definitions (classification and forecasting)}]
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{}lrr@{}}
    \toprule
    \textbf{Model} & \textbf{RMSE (passengers)} & \textbf{MAE} \\
    \midrule
