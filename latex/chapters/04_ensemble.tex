...
\begin{codebox}[title={Random Forest Regression with out-of-bag validation}]
...
\section{Reference Implementation}
\begin{codebox}[title={Random Forest Classification with stratified evaluation}]
...
\section{Reference Implementation}
\begin{codebox}[title={XGBoost classification on the heart data}]
...
\section{Reference Implementation}
\begin{codebox}[title={CatBoost with native categorical features}]
