...
\begin{lstlisting}[style=mlcode,caption={Scikit-Learn MLPClassifier: 64 -> 128 -> 64 -> 10}]
...
\begin{lstlisting}[style=mlcode,caption={Convert scaled NumPy arrays into PyTorch tensors + DataLoaders}]
...
\begin{lstlisting}[style=mlcode,caption={Training configuration}]
...
\begin{lstlisting}[style=mlcode,caption={Final evaluation on the held-out test set}]
