...
\begin{lstlisting}[style=mlcode,caption={Listing 1.1 Imports and plotting style}]
...
\begin{lstlisting}[style=mlcode,caption={Listing 1.2 Load and preprocess the Mall Customers data}]
...
\begin{lstlisting}[style=mlcode,caption={Listing 1.3 Select K with the elbow and silhouette curves}]
...
\begin{lstlisting}[style=mlcode,caption={Listing 1.4 Final K-means model (K = 5)}]
