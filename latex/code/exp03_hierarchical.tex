...
\begin{lstlisting}[style=mlcode,caption={Build the linkage matrix and draw the dendrogram}]
...
\begin{lstlisting}[style=mlcode,caption={Fit the final Agglomerative model (Ward linkage, K = 5)}]
