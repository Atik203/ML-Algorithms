...
\begin{lstlisting}[style=mlcode,caption={Load the California Housing dataset (real-world regression benchmark)}]
...
\begin{lstlisting}[style=mlcode,caption={Random Forest Regression (bagging of decision trees)}]
