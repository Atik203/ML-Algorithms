...
\begin{codebox}[title={Fit HDBSCAN (no global epsilon required)}]
...
plt.title(f"HDBSCAN on Global Earthquakes 2023 ({n_clusters_hdb} clusters, no eps)", fontsize=13, fontweight='bold')
