...
\begin{lstlisting}[style=mlcode,caption={Core libraries}]
# ---- Core libraries ----
import numpy as np
import pandas as pd
...
\begin{lstlisting}[style=mlcode,caption={GRNN class (from scratch)}]
...
\begin{lstlisting}[style=mlcode,caption={Load the real motorcycle impact data (MASS::mcycle)}]
...
\begin{lstlisting}[style=mlcode,caption={5-fold CV grid search for the optimal smoothing sigma}]
...
\begin{lstlisting}[style=mlcode,caption={Final model: refit with the CV-selected sigma and evaluate on a held-out split}]
