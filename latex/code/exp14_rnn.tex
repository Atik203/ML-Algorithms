...
\begin{lstlisting}[style=mlcode,caption={Vanilla RNN and LSTM model definitions}]
...
\begin{lstlisting}[style=mlcode,caption={Generic training function shared by both architectures}]
...
\begin{lstlisting}[style=mlcode,caption={Evaluate both models on the test horizon}]
...
\begin{lstlisting}[style=mlcode,caption={Sequence classification benchmark (manual experiment)}]
