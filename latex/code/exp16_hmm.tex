...
\begin{lstlisting}[style=mlcode,caption={Fit a 3-state Gaussian HMM with the Baum-Welch (EM) algorithm}]
...
\begin{lstlisting}[style=mlcode,caption={Transition probability matrix}]
